...
var input = prompt("1. Airtime-self \n 2. Airtime-Others \n 3. Data \n 4. Transfer")
switch(input){
  case "1":
  var amount = prompt("Input amount to recharge.");
    alert(`You have successfully recharged ${amount} naira!`);
    break;


  case "2":
  var phone_number = prompt("input phone number");
  var amount = prompt("Input amount to recharge.");
    switch(prompt(`Are you sure you want to recharge ${phone_number} with ${amount} naira? /n 1.YES /n 2. NO`))
        {case "1":
    alert(`You have successfully recharged ${phone_number} with ${amount} naira!`);
    break;
...
break;
  ...
  case "3":
  switch(prompt("Select data plan: \n 1. ₦100 for 100MB \n  2. ₦300 for 500MB \n 3. ₦700 for 1GB \n 4. ₦1500 for 2GB \n 5. ₦2500 for 5GB \n 6. ₦5000 for 12GB"))

  {case "1":
  var data_amount ="₦100 for 100MB";
  break;

  case "2":
  var data_amount ="₦300 for 500MB";
  break;

  case "3":
  var data_amount ="₦700 for 1GB";
  break;

  case "4":
  var data_amount ="₦1500 for 2GB";
  break;

  case "5":
  var data_amount ="₦2500 for 5GB";
  break;

  case "6":
  var data_amount ="₦5000 for 12GB";
  break;

  default:
  alert("Invalid Input.");}

  var confirm = prompt("Are you sure you want to subscribe to " + data_amount + "? \n 1. YES \n 2. NO");
  if (confirm == 1) {
 ...
 break;
  ...
  case "4":
  var account_number = prompt("input account number");
  var transfer_amount = prompt("Input amount to send.");
    switch(prompt(`Are you sure you want to send ${transfer_amount} naira to ${account_number}? /n 1.YES /n 2. NO`))
    {case "1":
    alert(`You have successfully sent ${transfer_amount} naira to ${account_number}!`);
    break;
